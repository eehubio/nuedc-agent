...
export const STAGE_ALLOWED_AGENTS: Record<ProjectStage, AgentType[]> = {
  ...
  BOM_CONFIRMED: ["orchestrator", "code_verifier", "code_generator", "integration_checker", "labsight_debug", "bom_agent", "procurement_planner"],
  HARDWARE_BUILD: ["orchestrator", "labsight_debug", "module_knowledge", "integration_checker", "bom_agent", "procurement_planner"],
  SOFTWARE_BUILD: ["orchestrator", "code_verifier", "code_generator", "labsight_debug", "bom_agent", "procurement_planner"],
  INTEGRATION: ["orchestrator", "code_verifier", "integration_checker", "labsight_debug", "code_generator", "bom_agent", "procurement_planner"],
  TESTING: ["orchestrator", "code_verifier", "labsight_debug", "test_scoring", "bom_agent", "procurement_planner"],
